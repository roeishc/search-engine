package com.handson.com.search_engine.util;
...
public class Dates {
    ...
    public static Date atUtc(LocalDateTime date, TimeZone zone) {
        ...
        calendar.set(date.getYear(), date.getMonthOfYear()-1, date.getDayOfMonth());    //convert from localDateTime to Calendar time
